...
class ArticleController extends Controller
{
    ...
    //     if ($article) {
    //         $articleFournisseurs = ArticleFournisseur::where('article_id', $articleId)->get();
    //         foreach ($articleFournisseurs as $af) {
    //             $af->delete();
    //         }
    ...
    //     }else{
    //         return response()->json(['message' => 'Article non existant'], 200);
    //     }
    // }
